...
define config.name = _("Романтическая встреча")
...
define gui.about = _p("""
Игра создана при поддержке мозговых клеток одной девушки.

Всё: изображения, звуки, музыка - взяты из открытых источников с разрешением свободного пользования.
""")
...
define build.name = "Romanticmeeting"
...
define config.save_directory = "Romanticmeeting-1688993901"
